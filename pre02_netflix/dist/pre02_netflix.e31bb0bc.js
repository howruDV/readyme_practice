...
var input_pw_check = document.getElementById("input_pw_check");
var input_name = document.getElementById("input_name");
var input_bio = document.getElementById("input_bio");
...
var register = function register() {
  ...
  if (input_pw.value == input_pw_check.value) {
    _axios.default.post("http://3.37.140.20:5000/api/v1/account/register", formData).then(function (res) {
      if (res.data.ok == true) alert("회원가입 성공!");else alert("회원가입 실패 :(");
...
//# sourceMappingURL=/pre02_netflix.e31bb0bc.js.map