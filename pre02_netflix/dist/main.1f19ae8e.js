...
var id = 1;
var url = "http://3.37.140.20:5000/api/v1/movie/" + id;
var befButton = document.querySelector("#left");
...
var draw = function draw() {
  ...
  fetch(url).then(function (res) {
    ...
    console.log("".concat(data.status, ", movie id: ").concat(id)); //오류처리
    ...
    var quality = document.querySelector("#view");
    var des = document.querySelector(".movie_des");
    var play = document.querySelector("#current");
    var bg_img = document.getElementById("mainpg_background");
    id = data.data.id;
    ...
    bg_img.src = data.data.image; //star 초기화

    var star = document.querySelector(".star");
    star.innerHTML = '';
    var star_cnt = data.data.star;

    for (var i = 0; i < star_cnt; i++) {
      var star_full = document.createElement("img");
      star_full.src = "./img/Star3.png";
      star.appendChild(star_full);
    }

    for (var _i = 0; _i < 5 - star_cnt; _i++) {
      var star_empty = document.createElement("img");
